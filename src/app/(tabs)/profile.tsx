...
export default function ProfileScreen() {
    const { authState, logout } = useZync();
    ...
    return (
        <ScreenLayout style={styles.container}>
            <View style={styles.header}>
                ...
                <ThemedText style={styles.name}>{authState.user?.name || 'User'}</ThemedText>
                <ThemedText style={styles.email}>{authState.user?.email || 'email@example.com'}</ThemedText>
            </View>
